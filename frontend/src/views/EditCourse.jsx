...
import { Button, Form, Container, Row, Col, Card, Accordion, Image } from 'react-bootstrap';
import { ChevronUp, ChevronDown, Trash, Plus } from 'react-bootstrap-icons';
                                ...
                                {section.resources?.map((resource, resourceIndex) => (
                                    <Card key={resourceIndex} className="mb-3">
                                        <Card.Body>
                                            ...
                                            {/* Campo de texto - aparece para todos os tipos */}
                                            <Form.Group className="mb-3">
                                            ...
                                            <Form.Group className="mb-3">
                                                ...
                                                <div className="d-flex gap-2 align-items-end">
                                                    ...
                                                    {/* Botão de upload para Documento */}
                                                    {resource.typeId === 1 && (
                                            ...
                                            {/* Campo de link - aparece para tipo Link e Vídeo */}
                                            ...
                                            {/* Mostrar ficheiro atual se existir */}
                                            {resource.file && (
                                                <Form.Group className="mb-3">
